...
$maxResult = mysqli_query($conn, "SELECT MAX(CAST(SUBSTRING(invoice_number, 5) AS UNSIGNED)) AS max_num FROM invoices");
$maxNum = mysqli_fetch_assoc($maxResult)["max_num"] ?? 0;
$invoice_number = "INV-" . str_pad($maxNum + 1, 6, "0", STR_PAD_LEFT);
