...
// Log errors server-side, but never display them to the browser —
// a stack trace or DB error here would leak internal details to
...
require_once "../backend/includes/csrf.php";
...
<head>
    ...
    <!-- CSRF token for patient.js to attach to state-changing requests -->
