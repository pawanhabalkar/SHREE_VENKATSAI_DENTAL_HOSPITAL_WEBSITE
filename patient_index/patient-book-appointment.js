// CSRF token for this session. This page is a static HTML file (no
// server-rendered <meta> tag available), so it's fetched once on
// load from the session-cookie-authenticated csrf_token.php endpoint
// and cached here for the booking submit to attach.
let csrfToken = "";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    appointmentForm.addEventListener(
        ...
        function (event) {
            ...
            // appointments.notes is a real column the receptionist desk
            // already displays (get_appointments.php selects it) — it
            // was just never being sent by this form before.
