...
let departmentsData = [];
let doctorsData = [];
let csrfToken = ""; // picked up from check_session.php, attached to every state-changing request below

function getCsrfToken() {
    return csrfToken;
}

// Escapes text before it's dropped into innerHTML, so values that came
// from the database (patient names, doctor names, etc.) can't break
// out of the HTML and run as script.
