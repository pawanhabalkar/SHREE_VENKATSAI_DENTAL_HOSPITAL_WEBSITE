...
// CSRF token for this session — fetched once on load (this is a
// public, unauthenticated page, so there's no server-rendered
// <meta> tag to read it from) and attached to the booking submit.
let csrfToken = "";
    ...
    form.addEventListener("submit", function (event) {
        ...
        .then(data => {
            ...
            if (data.result === "success") {
                ...
                const loginEmail = email.value.trim() || `public_${phone.value.trim()}@no-email.local`;
